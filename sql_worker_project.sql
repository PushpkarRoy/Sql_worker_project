...
INSERT INTO Worker (
    ...
    ('Niharika', 'Verma', 80000, '2020-06-11 09:00:00', 'Admin'),
    ('Vishal', 'Singhal', 300000, '2020-02-14 09:00:00', 'HR'),
    ('Amitabh', 'Singh', 500000, '2020-02-14 09:00:00', 'Admin'),
    ('Vivek', 'Bhati', 500000, '2020-06-11 09:00:00', 'Admin'),
    ('Vipul', 'Diwan', 200000, '2020-06-11 09:00:00', 'Account'),
    ('Satish', 'Kumar', 75000, '2020-01-20 09:00:00', 'Account'),
    ('Geetika', 'Chauhan', 90000, '2020-04-11 09:00:00', 'Admin');
...
select worker_id
from worker
where worker_id not in (select worker_ref_id
from bonus);
